...
define('EMAIL_FROM',                            'computer.fix@gmail.com');		// e.g. email@example.com
define('EMAIL_BCC',                            	'');		// e.g. email@example.com
define('FROM_NAME',                             'computer');	// Your system name
...
define('SMTP_USER',                             'computer.fix@gmail.com');		// your smtp user
